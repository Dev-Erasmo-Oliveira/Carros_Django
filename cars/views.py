...
#View que irá abrir os detalhes e renderizar o template sobre os detalhes do carro
...
# metodo decorator irá obrigar o usuário a fazer login antes de conseguir acessar o NEW CAR
